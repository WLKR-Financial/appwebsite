...
export default class DebtIssuanceModuleV2Wrapper {
    private provider;
    private contracts;
    private debtIssuanceModuleV2Address;
    constructor(provider: Provider, debtIssuanceModuleV2Address: Address);
    /**
     ...
     */
    initialize(setTokenAddress: Address, maxManagerFee: BigNumber, managerIssueFee: BigNumber, managerRedeemFee: BigNumber, feeRecipient: Address, managerIssuanceHook?: Address, callerAddress?: Address, txOpts?: TransactionOverrides): Promise<ContractTransaction>;
    /**
     ...
     */
    calculateTotalFees(setTokenAddress: Address, quantity: BigNumber, isIssue: boolean, callerAddress?: Address): Promise<[
        BigNumber,
        BigNumber,
        BigNumber
    ] & {
