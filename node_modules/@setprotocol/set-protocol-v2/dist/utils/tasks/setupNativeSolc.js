...
exports.setupNativeSolc = void 0;
...
function setupNativeSolc(_a, _b, runSuper) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            solcVersionOutput = "";
            try {
                solcVersionOutput = (0, child_process_1.execSync)("solc --version").toString();
            }
            catch (error) {
            ...
            isFirstRun = false;
            output = (0, child_process_1.execSync)("solc --standard-json", {
...
exports.setupNativeSolc = setupNativeSolc;
