        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_l) {
                switch (_l.label) {
                    ...
                    case 5:
                        _c.integrationRegistry = _l.sent();
                        _d = this;
                    ...
                    case 7:
                        _e.priceOracle = _l.sent();
                        _f = this;
                        return [4 /*yield*/, this._deployer.core.deployIntegrationRegistry(this.controller.address)];
                    case 8:
                        _f.integrationRegistry = _l.sent();
                        _g = this;
                        return [4 /*yield*/, this._deployer.core.deploySetValuer(this.controller.address)];
                    case 9:
                        _g.setValuer = _l.sent();
                        _h = this;
                        return [4 /*yield*/, this._deployer.modules.deployStreamingFeeModule(this.controller.address)];
                    case 10:
                        _h.streamingFeeModule = _l.sent();
                        _j = this;
                        return [4 /*yield*/, this._deployer.modules.deployNavIssuanceModule(this.controller.address, this.weth.address)];
                    case 11:
                        _j.navIssuanceModule = _l.sent();
            ...
            return __generator(this, function (_j) {
                switch (_j.label) {
                    ...
                    case 1:
                        _a.weth = _j.sent();
                        _b = this;
                        return [4 /*yield*/, this._deployer.mocks.deployTokenMock(this._ownerAddress, (0, common_1.ether)(10000), 6)];
                    case 2:
                        _b.usdc = _j.sent();
                        _c = this;
                        return [4 /*yield*/, this._deployer.mocks.deployTokenMock(this._ownerAddress, (0, common_1.ether)(10000), 8)];
                    case 3:
                        _c.wbtc = _j.sent();
                        _d = this;
                        return [4 /*yield*/, this._deployer.mocks.deployTokenMock(this._ownerAddress, (0, common_1.ether)(1000000), 18)];
                    case 4:
                        _d.dai = _j.sent();
                        this.component1Price = (0, common_1.ether)(230);
                        this.component2Price = (0, common_1.ether)(1);
                        this.component3Price = (0, common_1.ether)(9000);
                        this.component4Price = (0, common_1.ether)(1);
                        _e = this;
                    ...
                    case 8:
                        ...
                        return [4 /*yield*/, this.weth.deposit({ value: (0, common_1.ether)(5000) })];
                    case 9:
                        _j.sent();
                        return [4 /*yield*/, this.weth.approve(this.issuanceModule.address, (0, common_1.ether)(10000))];
                    case 10:
                        _j.sent();
                        return [4 /*yield*/, this.usdc.approve(this.issuanceModule.address, (0, common_1.ether)(10000))];
                    case 11:
                        _j.sent();
                        return [4 /*yield*/, this.wbtc.approve(this.issuanceModule.address, (0, common_1.ether)(10000))];
                    case 12:
                        _j.sent();
                        return [4 /*yield*/, this.dai.approve(this.issuanceModule.address, (0, common_1.ether)(10000))];
                    case 13:
                        _j.sent();
                        return [2 /*return*/];
                }
