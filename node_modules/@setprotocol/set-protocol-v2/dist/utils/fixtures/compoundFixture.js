...
var CompoundFixture = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_j) {
                switch (_j.label) {
                    ...
                    case 8:
                        _j.sent();
                        return [4 /*yield*/, this.comptroller._setCloseFactor((0, common_1.ether)(0.5))];
                    case 9:
                        _j.sent();
                        return [4 /*yield*/, this.comptroller._setLiquidationIncentive((0, common_1.ether)(1.08))];
                    case 10:
                        _j.sent();
                        // deploy Interest rate model
                        _e = this;
                        return [4 /*yield*/, this._deployer.external.deployWhitePaperInterestRateModel((0, common_1.ether)(1), // To change
                            (0, common_1.ether)(1))];
                    case 11:
                        // deploy Interest rate model
                    ...
                    case 12:
                        // Deploy COMP governance
                        _f.comp = _j.sent();
                        return [4 /*yield*/, this.comp.transfer(this.comptroller.address, (0, common_1.ether)(400000))];
                    case 13:
                        _j.sent();
                        _g = this;
    ...
    CompoundFixture.prototype.initializeGovernorBravo = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, setAdminData, eta, initiateCallData;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, this._deployer.external.deployCompoundGovernorBravoDelegate()];
                    case 1:
                        _a.compoundGovernorBravoDelegate = _c.sent();
                        _b = this;
                        return [4 /*yield*/, this._deployer.external.deployCompoundGovernorBravoDelegator(this.compoundTimelock.address, this.comp.address, this._ownerAddress, this.compoundGovernorBravoDelegate.address, 10000, 1, (0, common_1.ether)(100000))];
                    case 2:
                        _b.compoundGovernorBravoDelegator = _c.sent();
                        setAdminData = this.compoundTimelock.interface.encodeFunctionData("setPendingAdmin", [this.compoundGovernorBravoDelegator.address]);
                        return [4 /*yield*/, (0, test_1.getLastBlockTimestamp)()];
                    case 3:
                        eta = (_c.sent()).add(constants_1.ONE_DAY_IN_SECONDS.mul(2)).add(1);
                        return [4 /*yield*/, this.compoundTimelock.queueTransaction(this.compoundTimelock.address, 0, "", setAdminData, eta)];
                    case 4:
                        _c.sent();
                        return [4 /*yield*/, (0, test_1.increaseTimeAsync)(constants_1.ONE_DAY_IN_SECONDS.mul(2).add(2))];
                    case 5:
                        _c.sent();
                        return [4 /*yield*/, this.compoundTimelock.executeTransaction(this.compoundTimelock.address, 0, "", setAdminData, eta)];
                    case 6:
                        _c.sent();
                        return [4 /*yield*/, this.comp.delegate(this._ownerAddress)];
                    case 7:
                        _c.sent();
                        return [4 /*yield*/, this.compoundGovernorAlpha.connect(this._ownerSigner).propose([constants_1.ADDRESS_ZERO], [0], [""], [constants_1.ZERO_BYTES], "dummy prop")];
                    case 8:
                        _c.sent();
                        initiateCallData = this.compoundGovernorBravoDelegate.interface.encodeFunctionData("_initiate", [this.compoundGovernorAlpha.address]);
                        return [4 /*yield*/, this.compoundGovernorBravoDelegator.fallback({ data: initiateCallData })];
                    case 9:
                        _c.sent();
                        return [2 /*return*/];
                }
