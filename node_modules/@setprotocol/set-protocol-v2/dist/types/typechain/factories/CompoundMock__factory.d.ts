...
export declare class CompoundMock__factory extends ContractFactory {
    constructor(linkLibraryAddresses: CompoundMockLibraryAddresses, signer?: Signer);
    static linkBytecode(linkLibraryAddresses: CompoundMockLibraryAddresses): string;
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): CompoundMock;
}
