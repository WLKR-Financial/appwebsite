...
var BaseStrategy__factory = /** @class */ (function () {
    function BaseStrategy__factory() {
    }
    BaseStrategy__factory.createInterface = function () {
        return new ethers_1.utils.Interface(_abi);
    };
    BaseStrategy__factory.connect = function (address, signerOrProvider) {
        return new ethers_1.Contract(address, _abi, signerOrProvider);
    };
    BaseStrategy__factory.abi = _abi;
    return BaseStrategy__factory;
}());
