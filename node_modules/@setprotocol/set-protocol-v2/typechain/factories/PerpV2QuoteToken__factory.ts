...
import type {
  PerpV2QuoteToken,
  PerpV2QuoteTokenInterface,
} from "../PerpV2QuoteToken";
...
export class PerpV2QuoteToken__factory extends ContractFactory {
  ...
  deploy(
    ...
    return super.deploy(overrides || {}) as Promise<PerpV2QuoteToken>;
  }
  ...
  attach(address: string): PerpV2QuoteToken {
    return super.attach(address) as PerpV2QuoteToken;
  }
  connect(signer: Signer): PerpV2QuoteToken__factory {
    return super.connect(signer) as PerpV2QuoteToken__factory;
  }
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): PerpV2QuoteTokenInterface {
    return new utils.Interface(_abi) as PerpV2QuoteTokenInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): PerpV2QuoteToken {
    return new Contract(address, _abi, signerOrProvider) as PerpV2QuoteToken;
  }
}
