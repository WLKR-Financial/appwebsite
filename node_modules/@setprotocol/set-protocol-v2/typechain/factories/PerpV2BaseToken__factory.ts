...
import type {
  PerpV2BaseToken,
  PerpV2BaseTokenInterface,
} from "../PerpV2BaseToken";
...
export class PerpV2BaseToken__factory extends ContractFactory {
  ...
  deploy(
    ...
    return super.deploy(overrides || {}) as Promise<PerpV2BaseToken>;
  }
  ...
  attach(address: string): PerpV2BaseToken {
    return super.attach(address) as PerpV2BaseToken;
  }
  connect(signer: Signer): PerpV2BaseToken__factory {
    return super.connect(signer) as PerpV2BaseToken__factory;
  }
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): PerpV2BaseTokenInterface {
    return new utils.Interface(_abi) as PerpV2BaseTokenInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): PerpV2BaseToken {
    return new Contract(address, _abi, signerOrProvider) as PerpV2BaseToken;
  }
}
