...
import type {
  PerpV2VirtualToken,
  PerpV2VirtualTokenInterface,
} from "../PerpV2VirtualToken";
...
export class PerpV2VirtualToken__factory extends ContractFactory {
  ...
  deploy(
    ...
    return super.deploy(overrides || {}) as Promise<PerpV2VirtualToken>;
  }
  ...
  attach(address: string): PerpV2VirtualToken {
    return super.attach(address) as PerpV2VirtualToken;
  }
  connect(signer: Signer): PerpV2VirtualToken__factory {
    return super.connect(signer) as PerpV2VirtualToken__factory;
  }
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): PerpV2VirtualTokenInterface {
    return new utils.Interface(_abi) as PerpV2VirtualTokenInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): PerpV2VirtualToken {
    return new Contract(address, _abi, signerOrProvider) as PerpV2VirtualToken;
  }
}
