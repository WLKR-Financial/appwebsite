...
export class PerpV2Vault__factory extends ContractFactory {
  ...
  deploy(
    ...
    return super.deploy(overrides || {}) as Promise<PerpV2Vault>;
  }
  ...
  attach(address: string): PerpV2Vault {
    return super.attach(address) as PerpV2Vault;
  }
  connect(signer: Signer): PerpV2Vault__factory {
    return super.connect(signer) as PerpV2Vault__factory;
  }
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): PerpV2VaultInterface {
    return new utils.Interface(_abi) as PerpV2VaultInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): PerpV2Vault {
    return new Contract(address, _abi, signerOrProvider) as PerpV2Vault;
  }
}
