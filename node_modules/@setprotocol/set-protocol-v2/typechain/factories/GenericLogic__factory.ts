...
export class GenericLogic__factory extends ContractFactory {
  ...
  connect(signer: Signer): GenericLogic__factory {
    return super.connect(signer) as GenericLogic__factory;
  }
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): GenericLogicInterface {
    return new utils.Interface(_abi) as GenericLogicInterface;
  }
  static connect(
    address: string,
