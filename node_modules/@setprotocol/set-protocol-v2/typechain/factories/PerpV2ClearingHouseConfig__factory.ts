...
import type {
  ...
  PerpV2ClearingHouseConfigInterface,
} from "../PerpV2ClearingHouseConfig";
...
export class PerpV2ClearingHouseConfig__factory extends ContractFactory {
  ...
  deploy(
    ...
    return super.deploy(overrides || {}) as Promise<PerpV2ClearingHouseConfig>;
  }
  ...
  attach(address: string): PerpV2ClearingHouseConfig {
    return super.attach(address) as PerpV2ClearingHouseConfig;
  }
  connect(signer: Signer): PerpV2ClearingHouseConfig__factory {
    return super.connect(signer) as PerpV2ClearingHouseConfig__factory;
  }
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): PerpV2ClearingHouseConfigInterface {
    return new utils.Interface(_abi) as PerpV2ClearingHouseConfigInterface;
  }
  static connect(
    address: string,
