...
import type {
  ...
  PerpV2MarketRegistryInterface,
} from "../PerpV2MarketRegistry";
...
export class PerpV2MarketRegistry__factory extends ContractFactory {
  ...
  deploy(
    ...
    return super.deploy(overrides || {}) as Promise<PerpV2MarketRegistry>;
  }
  ...
  attach(address: string): PerpV2MarketRegistry {
    return super.attach(address) as PerpV2MarketRegistry;
  }
  connect(signer: Signer): PerpV2MarketRegistry__factory {
    return super.connect(signer) as PerpV2MarketRegistry__factory;
  }
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): PerpV2MarketRegistryInterface {
    return new utils.Interface(_abi) as PerpV2MarketRegistryInterface;
  }
  static connect(
    address: string,
