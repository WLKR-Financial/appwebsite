...
export class DelegateRegistry__factory extends ContractFactory {
  ...
  deploy(
    ...
    return super.deploy(overrides || {}) as Promise<DelegateRegistry>;
  }
  ...
  attach(address: string): DelegateRegistry {
    return super.attach(address) as DelegateRegistry;
  }
  connect(signer: Signer): DelegateRegistry__factory {
    return super.connect(signer) as DelegateRegistry__factory;
  }
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): DelegateRegistryInterface {
    return new utils.Interface(_abi) as DelegateRegistryInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): DelegateRegistry {
    return new Contract(address, _abi, signerOrProvider) as DelegateRegistry;
  }
}
