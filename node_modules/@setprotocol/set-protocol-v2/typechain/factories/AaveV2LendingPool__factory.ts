...
export class AaveV2LendingPool__factory extends ContractFactory {
  constructor(
    linkLibraryAddresses: AaveV2LendingPoolLibraryAddresses,
    signer?: Signer
  ) {
    super(
      _abi,
      AaveV2LendingPool__factory.linkBytecode(linkLibraryAddresses),
      signer
    );
  }
  ...
  deploy(
    ...
    return super.deploy(overrides || {}) as Promise<AaveV2LendingPool>;
  }
  ...
  attach(address: string): AaveV2LendingPool {
    return super.attach(address) as AaveV2LendingPool;
  }
  connect(signer: Signer): AaveV2LendingPool__factory {
    return super.connect(signer) as AaveV2LendingPool__factory;
  }
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): AaveV2LendingPoolInterface {
    return new utils.Interface(_abi) as AaveV2LendingPoolInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): AaveV2LendingPool {
    return new Contract(address, _abi, signerOrProvider) as AaveV2LendingPool;
  }
}
