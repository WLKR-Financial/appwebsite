...
import type {
  ...
  LendingPoolDataProviderInterface,
...
export class LendingPoolDataProvider__factory extends ContractFactory {
  ...
  connect(signer: Signer): LendingPoolDataProvider__factory {
    return super.connect(signer) as LendingPoolDataProvider__factory;
  }
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): LendingPoolDataProviderInterface {
    return new utils.Interface(_abi) as LendingPoolDataProviderInterface;
  }
  static connect(
    address: string,
