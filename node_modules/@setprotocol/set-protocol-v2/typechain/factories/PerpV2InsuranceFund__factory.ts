...
import type {
  PerpV2InsuranceFund,
  PerpV2InsuranceFundInterface,
} from "../PerpV2InsuranceFund";
...
export class PerpV2InsuranceFund__factory extends ContractFactory {
  ...
  deploy(
    ...
    return super.deploy(overrides || {}) as Promise<PerpV2InsuranceFund>;
  }
  ...
  attach(address: string): PerpV2InsuranceFund {
    return super.attach(address) as PerpV2InsuranceFund;
  }
  connect(signer: Signer): PerpV2InsuranceFund__factory {
    return super.connect(signer) as PerpV2InsuranceFund__factory;
  }
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): PerpV2InsuranceFundInterface {
    return new utils.Interface(_abi) as PerpV2InsuranceFundInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): PerpV2InsuranceFund {
    return new Contract(address, _abi, signerOrProvider) as PerpV2InsuranceFund;
  }
}
