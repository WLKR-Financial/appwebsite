...
interface ClaimAdapterMockInterface extends ethers.utils.Interface {
  functions: {
...
export class ClaimAdapterMock extends BaseContract {
  ...
  interface: ClaimAdapterMockInterface;
