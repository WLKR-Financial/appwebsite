...
interface YearnWrapV2AdapterInterface extends ethers.utils.Interface {
  functions: {
...
export class YearnWrapV2Adapter extends BaseContract {
  ...
  interface: YearnWrapV2AdapterInterface;
