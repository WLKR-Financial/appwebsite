...
interface UniswapYieldHookInterface extends ethers.utils.Interface {
  functions: {
...
export class UniswapYieldHook extends BaseContract {
  ...
  interface: UniswapYieldHookInterface;
