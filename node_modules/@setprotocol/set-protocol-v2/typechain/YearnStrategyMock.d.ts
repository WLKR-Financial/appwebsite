...
interface YearnStrategyMockInterface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: "_setWant", values: [string]): string;
  encodeFunctionData(
...
export class YearnStrategyMock extends BaseContract {
  ...
  interface: YearnStrategyMockInterface;
  ...
  tendTrigger(arg0: BigNumberish, overrides?: CallOverrides): Promise<boolean>;
  ...
  filters: {
    Cloned(
      clone?: string | null
    ): TypedEventFilter<[string], { clone: string }>;

    EmergencyExitEnabled(): TypedEventFilter<[], {}>;
    ...
    UpdatedMetadataURI(
      metadataURI?: null
    ): TypedEventFilter<[string], { metadataURI: string }>;
    ...
    UpdatedStrategist(
      newStrategist?: null
    ): TypedEventFilter<[string], { newStrategist: string }>;
  };
