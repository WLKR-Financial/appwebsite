...
interface IIndexExchangeAdapterInterface extends ethers.utils.Interface {
  functions: {
...
export class IIndexExchangeAdapter extends BaseContract {
  ...
  interface: IIndexExchangeAdapterInterface;
