...
interface SlippageIssuanceModuleInterface extends ethers.utils.Interface {
  functions: {
    ...
    "issueWithSlippage(address,uint256,address[],uint256[],address)": FunctionFragment;
    "redeem(address,uint256,address)": FunctionFragment;
    "redeemWithSlippage(address,uint256,address[],uint256[],address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "issueWithSlippage",
  ...
  encodeFunctionData(
    functionFragment: "redeemWithSlippage",
    values: [string, BigNumberish, string[], BigNumberish[], string]
  ): string;
  encodeFunctionData(
...
export class SlippageIssuanceModule extends BaseContract {
  ...
  interface: SlippageIssuanceModuleInterface;
  ...
  functions: {
    ...
    issueWithSlippage(
      _setToken: string,
      _setQuantity: BigNumberish,
      _checkedComponents: string[],
      _maxTokenAmountsIn: BigNumberish[],
      _to: string,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
    ...
    redeemWithSlippage(
      ...
      _setQuantity: BigNumberish,
      _checkedComponents: string[],
      _minTokenAmountsOut: BigNumberish[],
      _to: string,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
