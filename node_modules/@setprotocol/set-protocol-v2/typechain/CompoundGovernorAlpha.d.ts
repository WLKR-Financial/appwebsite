...
interface CompoundGovernorAlphaInterface extends ethers.utils.Interface {
  functions: {
...
export class CompoundGovernorAlpha extends BaseContract {
  ...
  interface: CompoundGovernorAlphaInterface;
