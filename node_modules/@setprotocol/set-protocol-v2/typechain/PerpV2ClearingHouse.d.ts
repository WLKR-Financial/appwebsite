...
interface PerpV2ClearingHouseInterface extends ethers.utils.Interface {
  functions: {
    ...
    "settleAllFundingAndPendingFee(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "settleAllFundingAndPendingFee",
    values: [string]
  ): string;
  encodeFunctionData(
...
export class PerpV2ClearingHouse extends BaseContract {
