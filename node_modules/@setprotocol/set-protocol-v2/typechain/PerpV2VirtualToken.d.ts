...
interface PerpV2VirtualTokenInterface extends ethers.utils.Interface {
  functions: {
...
export class PerpV2VirtualToken extends BaseContract {
  ...
  interface: PerpV2VirtualTokenInterface;
