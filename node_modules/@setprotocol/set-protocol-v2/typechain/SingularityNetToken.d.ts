...
interface SingularityNetTokenInterface extends ethers.utils.Interface {
  functions: {
...
export class SingularityNetToken extends BaseContract {
  ...
  interface: SingularityNetTokenInterface;
