...
interface AaveV2StableDebtTokenInterface extends ethers.utils.Interface {
  functions: {
...
export class AaveV2StableDebtToken extends BaseContract {
  ...
  interface: AaveV2StableDebtTokenInterface;
