...
interface PerpV2OrderBookInterface extends ethers.utils.Interface {
  functions: {
    "addLiquidity(tuple)": FunctionFragment;
    "candidate()": FunctionFragment;
    "getClearingHouse()": FunctionFragment;
    "getExchange()": FunctionFragment;
    "getFeeGrowthGlobal(address)": FunctionFragment;
    ...
    "getOwedFee(address,address,int24,int24)": FunctionFragment;
    ...
    "removeLiquidityByIds(address,address,bytes32[])": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "removeLiquidityByIds",
  ...
  decodeFunctionResult(functionFragment: "getOwedFee", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "getTotalOrderDebt",
    data: BytesLike
  ): Result;
...
export class PerpV2OrderBook extends BaseContract {
  ...
  functions: {
    ...
    updateOrderDebt(
      orderId: BytesLike,
      deltaBaseDebt: BigNumberish,
      deltaQuoteDebt: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    removeLiquidity(
      ...
      [BigNumber, BigNumber, BigNumber, BigNumber, BigNumber] & {
        ...
        quote: BigNumber;
        fee: BigNumber;
        deltaTakerBase: BigNumber;
        deltaTakerQuote: BigNumber;
      }
    >;
