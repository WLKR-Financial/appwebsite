...
interface UniswapGovernorAlphaInterface extends ethers.utils.Interface {
  functions: {
...
export class UniswapGovernorAlpha extends BaseContract {
  ...
  interface: UniswapGovernorAlphaInterface;
