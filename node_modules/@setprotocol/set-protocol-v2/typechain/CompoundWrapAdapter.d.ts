...
interface CompoundWrapAdapterInterface extends ethers.utils.Interface {
  functions: {
...
export class CompoundWrapAdapter extends BaseContract {
  ...
  interface: CompoundWrapAdapterInterface;
