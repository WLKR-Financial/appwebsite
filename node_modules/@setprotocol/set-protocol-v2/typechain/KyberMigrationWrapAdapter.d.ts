...
interface KyberMigrationWrapAdapterInterface extends ethers.utils.Interface {
  functions: {
    ...
    "kncLegacyToken()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "kncLegacyToken",
    values?: undefined
  ): string;
...
export class KyberMigrationWrapAdapter extends BaseContract {
  ...
  interface: KyberMigrationWrapAdapterInterface;
  ...
  functions: {
    ...
    kncLegacyToken(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    kncLegacyToken(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    kncLegacyToken(overrides?: CallOverrides): Promise<PopulatedTransaction>;
