...
interface ManagerIssuanceHookMockInterface extends ethers.utils.Interface {
  functions: {
    ...
    "retrievedIssueQuantity()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "retrievedIssueQuantity",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class ManagerIssuanceHookMock extends BaseContract {
  ...
  functions: {
    ...
    retrievedIssueQuantity(overrides?: CallOverrides): Promise<[BigNumber]>;
